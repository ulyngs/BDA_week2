...
```{r compare-functions}
#a is normally distributed, b is a power law, c is log normal, d is exponential
# make the data 'long'
...
This is because with a power law function the formula is: f(x) = x^b. The exponent stays constant, whilst the base increases. So if our exponent is 2 and the base ranges from 1 to 10, we get: 1, 4, 9, 16, 25, 36, 49, 64, 81, 100. 
With an exponential function the formula is: f(x) = b^x. The exponent increases whilst the base stays constant. So if our base is 2 and our exponent x range from 1 to 10 we get: 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024.
